...
abstract class $ArticleCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? author, String? title, String? url, String? publishedAt});
}
...
class _$_Article implements _Article {
  const _$_Article({this.author, this.title, this.url, this.publishedAt});
  ...
  @override
  String toString() {
    return 'Article(author: $author, title: $title, url: $url, publishedAt: $publishedAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, author, title, url, publishedAt);
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      final String? title,
      final String? url,
      final String? publishedAt}) = _$_Article;
