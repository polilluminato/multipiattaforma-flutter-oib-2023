...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? url, String? photographer, String? alt, PhotoSrc? src});
...
class _$_Photo implements _Photo {
  const _$_Photo({this.url, this.photographer, this.alt, this.src});
  ...
  @override
  String toString() {
    return 'Photo(url: $url, photographer: $photographer, alt: $alt, src: $src)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, photographer, alt, src);
